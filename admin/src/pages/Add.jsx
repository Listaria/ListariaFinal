          ...
          >
            {category === "Electronics" && (
              <>
                ...
                <option value="Home Audio & Speakers">
                  Home Audio & Speakers
                </option>
            ...
            {category === "Books" && (
              <>
                ...
                <option value="Academic & Study Guides">
      ...
      <div>
        ...
        <div className="flex gap-3">
          ...
          <p className="text-blue-500">
            Choose this if you are not listing Cloths
          </p>
          <div
            onClick={() =>
              setSizes((prev) =>
          ...
          >
            <p
              className={`${
                sizes.includes("NONE") ? "bg-pink-100" : "bg-slate-200"
              } px-3 py-1 cursor-pointer`}
            >
              NONE
            </p>
